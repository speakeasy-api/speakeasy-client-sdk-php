...
class GrantUserAccessToWorkspaceResponse
{
    /**
     ...
     * Success
     *
     * @var ?Shared\WorkspaceInviteResponse $workspaceInviteResponse
     */
    public ?Shared\WorkspaceInviteResponse $workspaceInviteResponse = null;
    ...
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Shared\WorkspaceInviteResponse $workspaceInviteResponse = null)
    {
        ...
        $this->workspaceInviteResponse = $workspaceInviteResponse;
    }
}