...
class GetRequestFromEventLogResponse
{
     ...
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Shared\UnboundedRequest $unboundedRequest = null)
    {
