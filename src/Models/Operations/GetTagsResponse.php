...
class GetTagsResponse
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Shared\GetTagsResponse $getTagsResponse = null)
    {
