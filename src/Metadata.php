...
class Metadata
{
    ...
    public function deleteVersionMetadata(Operations\DeleteVersionMetadataRequest $request): Operations\DeleteVersionMetadataResponse
    {
        ...
        $hookContext = new HookContext('deleteVersionMetadata', null, $this->sdkConfiguration->securitySource);
    ...
    public function getVersionMetadata(Operations\GetVersionMetadataRequest $request): Operations\GetVersionMetadataResponse
    {
        ...
        $hookContext = new HookContext('getVersionMetadata', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $options = Utils\Utils::convertHeadersToOptions($httpRequest, $options);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
        ...
        if ($statusCode >= 200 && $statusCode < 300) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, 'array<\Speakeasy\SpeakeasyClientSDK\Models\Shared\VersionMetadata>', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
    ...
    public function insertVersionMetadata(Operations\InsertVersionMetadataRequest $request): Operations\InsertVersionMetadataResponse
    {
        ...
        $hookContext = new HookContext('insertVersionMetadata', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $options = Utils\Utils::convertHeadersToOptions($httpRequest, $options);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
        ...
        if ($statusCode >= 200 && $statusCode < 300) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Speakeasy\SpeakeasyClientSDK\Models\Shared\VersionMetadata', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
