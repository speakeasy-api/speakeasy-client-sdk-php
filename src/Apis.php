...
class Apis
{
    ...
    public function deleteApi(Operations\DeleteApiRequest $request): Operations\DeleteApiResponse
    {
        ...
        $hookContext = new HookContext('deleteApi', null, $this->sdkConfiguration->securitySource);
    ...
    public function generateOpenApiSpec(Operations\GenerateOpenApiSpecRequest $request): Operations\GenerateOpenApiSpecResponse
    {
        ...
        $hookContext = new HookContext('generateOpenApiSpec', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $options = Utils\Utils::convertHeadersToOptions($httpRequest, $options);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
    ...
    public function generatePostmanCollection(Operations\GeneratePostmanCollectionRequest $request): Operations\GeneratePostmanCollectionResponse
    {
        ...
        $options['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext('generatePostmanCollection', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $options = Utils\Utils::convertHeadersToOptions($httpRequest, $options);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
    ...
    public function getAllApiVersions(Operations\GetAllApiVersionsRequest $request): Operations\GetAllApiVersionsResponse
    {
        ...
        $qp = Utils\Utils::getQueryParams(Operations\GetAllApiVersionsRequest::class, $request, $urlOverride, $this->sdkConfiguration->globals);
        $options['headers']['Accept'] = 'application/json';
        $options['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext('getAllApiVersions', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        ...
        if ($statusCode >= 200 && $statusCode < 300) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, 'array<\Speakeasy\SpeakeasyClientSDK\Models\Shared\Api>', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
    ...
    public function getApis(?Operations\GetApisRequest $request = null): Operations\GetApisResponse
    {
        ...
        $qp = Utils\Utils::getQueryParams(Operations\GetApisRequest::class, $request, $urlOverride, $this->sdkConfiguration->globals);
        $options['headers']['Accept'] = 'application/json';
        $options['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext('getApis', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $options['query'] = Utils\QueryParameters::standardizeQueryParams($httpRequest, $qp);
        $options = Utils\Utils::convertHeadersToOptions($httpRequest, $options);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
    ...
    public function upsertApi(Operations\UpsertApiRequest $request): Operations\UpsertApiResponse
    {
        ...
        $hookContext = new HookContext('upsertApi', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $options = Utils\Utils::convertHeadersToOptions($httpRequest, $options);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
        ...
        if ($statusCode >= 200 && $statusCode < 300) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Speakeasy\SpeakeasyClientSDK\Models\Shared\Api', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
