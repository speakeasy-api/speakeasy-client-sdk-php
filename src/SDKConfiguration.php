...
class SDKConfiguration
{
    ...
    public string $sdkVersion = '0.45.4';

    public string $genVersion = '2.452.0';

    public string $userAgent = 'speakeasy-sdk/php 0.45.4 2.452.0 0.4.0 speakeasy-api/speakeasy-client-sdk-php';
