...
class SDKConfiguration
{
    ...
    public string $sdkVersion = '0.38.11';

    public string $genVersion = '2.365.0';

    public string $userAgent = 'speakeasy-sdk/php 0.38.11 2.365.0 0.4.0 . speakeasy-api/speakeasy-client-sdk-php';
