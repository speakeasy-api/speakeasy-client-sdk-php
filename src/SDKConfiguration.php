...
class SDKConfiguration
{
    ...
    public string $sdkVersion = '0.38.12';

    public string $genVersion = '2.366.1';

    public string $userAgent = 'speakeasy-sdk/php 0.38.12 2.366.1 0.4.0 . speakeasy-api/speakeasy-client-sdk-php';
